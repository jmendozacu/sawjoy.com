...
Review.prototype.init = function () {
    this.initOpenReview();
    this.appendScrollBar($ji(this.sectionContainer + ' #iwd_opc_top_review_items_wrapper'));
};
...
Review.prototype.applyResponse = function (review) {
    var _this = this;
    $ji(this.sectionContainer).html(review).promise().done(function () {
        _this.appendScrollBar($ji(_this.sectionContainer + ' #iwd_opc_top_review_items_wrapper'));
    });
};
